...
`/usr/bin/cat /home/ansible/scripts/qpmf.txt | tr '\n' ',' > /home/ansible/scripts/test1.csv`;



my $q2 =  q{LOAD DATA  LOCAL INFILE '/home/ansible/scripts/test1.csv' INTO TABLE dns_stat 
