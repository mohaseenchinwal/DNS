...
`/usr/bin/cat /home/ansible/scripts/dns1sec.txt | tr '\n' ',' > /home/ansible/scripts/dns1sec.csv`;



my $q2 =  q{LOAD DATA  LOCAL INFILE '/home/ansible/scripts/dns1sec.csv' INTO TABLE dns1sec_stats
