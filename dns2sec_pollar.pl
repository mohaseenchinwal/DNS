...
`/usr/bin/cat /home/ansible/scripts/dns2sec.txt | tr '\n' ',' > /home/ansible/scripts/dns2sec.csv`;



my $q2 =  q{LOAD DATA  LOCAL INFILE '/home/ansible/scripts/dns2sec.csv' INTO TABLE dns2sec_stats
